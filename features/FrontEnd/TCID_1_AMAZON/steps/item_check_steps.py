...
from BDDCommon.CommonConfigs.locatorsconfig import AMAZON
from BDDCommon.CommonConfigs.locatorsconfig import AMAZON_HOME
...
def TCID_1_user_enters_any_item_in_search_bar(context):
    ...
    search_bar_locator = AMAZON['search bar']
...
def TCID_1_clicks_on_search_button(context):
    ...
    search_button = AMAZON_HOME['button']
...
def TCID_1_verify_page_title_contains_the_search_term(context, expected_text):
    ...
    search_result = AMAZON_HOME['search result']
